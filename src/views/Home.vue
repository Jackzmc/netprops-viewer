<template>
  <div class="home container">
    <h1 class="title is-1">Netprops Viewer</h1>
    <p class="subtitle is-4">Click a valid netprops, or upload a custom one.</p>
    <div class="buttons ">
      ...
      <b-button tag="router-link" to="custom">Upload Custom Netprops</b-button>
    </div>
    <hr />
